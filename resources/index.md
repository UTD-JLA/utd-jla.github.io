...
**NOTE:** As of 2023-07, `itazuraneko.neocities.org` is down permanently. Make sure to update any of your bookmarks to the mirror <https://djtguide.github.io>
...
* [**Tae Kim**](https://djtguide.github.io/grammar/taekim)
* [**Japanese with Cure Dolly**](https://www.youtube.com/playlist?list=PLg9uYxuZf8x_A-vcqqyOFZu06WlhnypWj)
* [Sakubi](https://djtguide.github.io/learn/anon/sakubi)
...
## Yomichan setup
When you first install Yomichan, you'll need some dictionaries. Ignore the ones on the Yomichan website, they're outdated. Instead, get the [JMDict from here](https://github.com/Aquafina-water-bottle/jmdict-english-yomichan) and the rest of them from [Shoui's collection](https://learnjapanese.link/dictionaries) or [Marv's collection](https://github.com/MarvNC/yomichan-dictionaries). Download the desired files and import in the Yomichan settings (don't extract the zip)
...
### Word audio
The default audio sources for Yomichan are not very good. Some seem incorrect or may not even be by native speakers. You can download a large collection of word audio and **use [local-audio-yomichan](https://github.com/themoeway/local-audio-yomichan) anki addon** to serve it to yomichan.
